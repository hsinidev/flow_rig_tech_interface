<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,5,30&height=180&section=header&text=Flow%20Rig%20Tech%20Interface&fontSize=42&fontColor=fff&animation=fadeIn&fontAlignY=38" width="100%" style="max-width: 100%; border-radius: 12px; margin-bottom: 20px;" alt="Flow Rig Tech Interface Header Banner" />

  <h1>🚀 Flow Rig Tech Interface</h1>
  ...
  <p align="center">
    ...
    <a href="https://github.com/hsinidev/flow_rig_tech_interface"><img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License: MIT" /></a>
  </p>
...
**Flow Rig Tech Interface** delivers a fast, responsive, and cross-platform browser experience built with **HTML** and hardware-accelerated canvas rendering.
...
```bash
git clone https://github.com/hsinidev/flow_rig_tech_interface.git
cd flow_rig_tech_interface
```
